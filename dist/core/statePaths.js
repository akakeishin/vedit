...
function explicitPath(env, name) {
 ...
 */
export function resolveRegistryPath(env = process.env, homeDir = os.homedir()) {
...
export function resolvePresetsPath(env = process.env, homeDir = os.homedir()) {
...
export function resolveWhisperModelDir(env = process.env, homeDir = os.homedir()) {
